...
#############################################################################################
parser.add_argument('--model_name', '-m', type=str, default='Student') # Student
parser.add_argument('--weight_name', '-w', type=str, default='Student')  #  Student
parser.add_argument('--file_name', '-f', type=str, default='final.pth')   #Teacher.pth, final
parser.add_argument('--dataset_split', '-d', type=str, default='test') 
parser.add_argument('--gpu', '-g', type=int, default=0)
#############################################################################################
parser.add_argument('--img_height', '-ih', type=int, default=576) 
parser.add_argument('--img_width', '-iw', type=int, default=1024)  
...
if __name__ == '__main__':
    ...
    print("* iou per class: \n    unlabeled: %.6f, road: %.6f" \
          %(iou_per_class[0]*100, iou_per_class[1]*100)) 
    print("* recall per class: \n    unlabeled: %.6f, road: %.6f" \
          %(recall_per_class[0]*100, recall_per_class[1]*100))
    print("* pre per class: \n    unlabeled: %.6f, road: %.6f" \
          %(precision_per_class[0]*100, precision_per_class[1]*100)) 
    print("* F1 per class: \n    unlabeled: %.6f, road: %.6f" \
          %(F1_per_class[0]*100, F1_per_class[1]*100)) 
