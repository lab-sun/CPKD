...
class Student(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.encoder_thermal_layer316 = Transformer(img_size=(18,32),patch_size=(2,2),in_channels=256, hidden_size = 256,out_channels=512,num_attention_heads = 16)  #res34
        ########  RGB ENCODER  ########
        ...
        self.encoder_rgb_layer316 = Transformer(img_size=(18,32),patch_size=(2,2),in_channels=256, hidden_size = 256,out_channels=512,num_attention_heads = 16)   #res34
    ...
    def forward(self, input):
        ...
        fuse = F.interpolate(fuse, scale_factor=2)
...
def unit_test():
    ...
    rtf = Student(2).cuda(0)
    out1,out2,out3,out4,out5,x = rtf(images)
